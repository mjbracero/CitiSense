...
export async function notifyDepartmentHeadsComplaintCompleted({
  ...
  const shortId = getComplaintLabel(complaint);
  const assignedOffice = department || complaint.department || complaint.assigned_office;
  ...
  return notifyDepartmentHeadsInDepartment({
    ...
    message: `Thank you for your hard work! Complaint #${shortId} has been marked as completed by the admin.`,
    status: "Completed",
    category: complaint.category,
    department: assignedOffice,
    locationText:
