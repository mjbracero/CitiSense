...
- Do NOT use "City Facility Concerns" as a catch-all for permits, certificates, taxes, licensing, utilities, roads, or general LGU services.
- Business permit, mayor's permit, licensing, and permit processing delays -> "Business Permit and Licensing Concerns" (City Business Permit and Licensing Office), NOT General Services Office.
- Birth/marriage/death certificates, civil registry, PSA records -> "Civil Registry Concerns" (City Civil Registrar's Office).
...
- "City Facility Concerns" is ONLY for physical city-owned buildings and facilities (city hall, gym, covered court, library, waiting areas, public restrooms, sports complexes).
