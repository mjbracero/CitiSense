 ...
 * Keeps allowsRecordingIOS true so Expo Go can switch to the recorder without
 * tearing down the iOS/Android audio session.
 */
export async function playMicStartFeedback() {
  ...
  try {
    ...
    // Give the native player a moment to release before recording prepares.
    await wait(180);
  }
}
